...
const app = Vue.createApp({
    ...
    methods: {
        ...
        requestLoan(){
            axios.post('http://localhost:8080/api/clients/current/loans',{ id: `${this.findLoanId}`, amount: `${this.loanAmount}`, payments: `${this.payments}`, destinationAccount: `${this.destinationAccount}`})
            .then(response => {
                this.loanToast = false
