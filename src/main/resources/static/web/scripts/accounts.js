...
const app = Vue.createApp({
    ...
    methods: {
        ...
        createAccount(){
            axios.post('/api/clients/current/accounts', `accountType=${this.chosenAccountType}`,
        ...
        deleteAccountConfirmation(){
            axios.patch('/api/clients/current/accounts/delete',`accountNumber=${this.deleted_account}`,
            {headers:{'content-type':'application/x-www-form-urlencoded'}})
            .then(response => {
